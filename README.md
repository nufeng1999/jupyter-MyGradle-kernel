![](https://img.shields.io/badge/Jupyter-Kernel-green?link=https://jupyter.org/&link=https://github.com/jupyter/jupyter/wiki/Jupyter-kernels) ![](https://img.shields.io/badge/MyGradle-Kernel-orange) ![](https://img.shields.io/github/watchers/nufeng1999/jupyter-MyGradle-kernel) <img alt="ViewCount" src="https://views.whatilearened.today/views/github/nufeng1999/jupyter-MyGradle-kernel.svg">
    <a href="https://github.com/nufeng1999/jupyter-MyGradle-kernel"><img alt="GitHub Clones" src="https://img.shields.io/badge/dynamic/json?color=success&label=Clone&query=count&url=https://raw.githubusercontent.com/nufeng1999/jupyter-MyGradle-kernel/master/clone.json&logo=github"></a>
# MyGradle kernel for Jupyter  
[Example](https://github.com/nufeng1999/jupyter-MyGradle-kernel/blob/master/example/MyGradle.ipynb "Example")
...
pip install zerorpc
git clone https://github.com/nufeng1999/jupyter-MyGradle-kernel.git
cd jupyter-MyGradle-kernel
pip install -e . 
cd jupyter_MyGradle_kernel && python3 install_MyGradle_kernel --user
